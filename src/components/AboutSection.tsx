  ...
  return <section id="about" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">Continuing a legacy of excellence, MGIT’s 36-hour national-level hackathon unites the nation’s brightest innovators to transform ideas into impactful, purpose-driven technological solutions.</p>
        </div>
